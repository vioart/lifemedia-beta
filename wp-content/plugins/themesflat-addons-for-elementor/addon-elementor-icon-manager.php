...
if(!class_exists('Addon_Elementor_Icon_manager_free')){
    class Addon_Elementor_Icon_manager_free extends Icons_Manager {

        private static function render_svg_icon( $value ) {
            if ( ! isset( $value['id'] ) ) {
                return '';
            }
            return Core\Files\Assets\Svg\Svg_Handler::get_inline_svg( $value['id'] );
        }
