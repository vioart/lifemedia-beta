...
class Skin_One extends Skin_Base
{
    ...
    {
        return __('Skin One', 'essential-addons-elementor');
    }
    ...
    public function section_style_menu(Widget_Base $widget)
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .eael-advanced-menu-container, {{WRAPPER}} .eael-advanced-menu-container .eael-advanced-menu-toggle, {{WRAPPER}} .eael-advanced-menu.eael-advanced-menu-horizontal.eael-advanced-menu-responsive',
            ]
        );
    ...
    public function section_style_dropdown(Widget_Base $widget)
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'eael-advanced-menu-dropdown-animate-fade',
                'condition' => [
                    'skin_one_eael_advanced_menu_layout' => ['horizontal'],
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'condition' => [
                    'skin_one_eael_advanced_menu_layout' => ['vertical'],
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .eael-advanced-menu-container .eael-advanced-menu.eael-advanced-menu-vertical li ul li a span svg path' => 'fill: {{VALUE}}',
    ...
    public function render()
    {
        ...
        $menu_classes = ['eael-advanced-menu', $settings['skin_one_eael_advanced_menu_dropdown_animation'], 'eael-advanced-menu-indicator', $settings['eael_advanced_menu_hamburger_menu_item_alignment'] ];
        $container_classes = ['eael-advanced-menu-container', $settings['skin_one_eael_advanced_menu_item_alignment'], $settings['skin_one_eael_advanced_menu_dropdown_item_alignment']];
        ...
        if( \Elementor\Plugin::instance()->editor->is_edit_mode() ){
            $container_classes[] = 'ieael-hamburger--not-responsive';
        }
        
        if ($settings['skin_one_eael_advanced_menu_layout'] == 'horizontal') {
            $menu_classes[] = 'eael-advanced-menu-horizontal';
        } else {
            $menu_classes[] = 'eael-advanced-menu-vertical';
        }

        if (isset($settings['skin_one_eael_advanced_menu_item_dropdown_indicator']) && $settings['skin_one_eael_advanced_menu_item_dropdown_indicator'] == 'yes') {
        ...
        //For Vertical Menu
        if ( isset( $settings['skin_one_eael_advanced_menu_item_indicator'] ) ) {
            ob_start();
            Icons_Manager::render_icon( $settings['skin_one_eael_advanced_menu_item_indicator'], [ 'aria-hidden' => 'true' ] );
        ...
        //For Dropdown Menu
        if ( isset( $settings['skin_one_eael_advanced_menu_dropdown_item_indicator'] ) ) {
            ob_start();
            Icons_Manager::render_icon( $settings['skin_one_eael_advanced_menu_dropdown_item_indicator'], [ 'aria-hidden' => 'true' ] );
