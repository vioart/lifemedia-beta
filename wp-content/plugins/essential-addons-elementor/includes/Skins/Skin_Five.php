...
class Skin_Five extends Skin_Base
{
    ...
    {
        return __('Skin Five', 'essential-addons-elementor');
    }
    ...
    public function section_style_dropdown(Widget_Base $widget)
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'condition' => [
                    'skin_five_eael_advanced_menu_layout' => ['horizontal'],
                ],
            ]
        );
    ...
    public function render()
    {
        ...
        if (isset($settings['skin_five_eael_advanced_menu_item_dropdown_indicator']) && $settings['skin_five_eael_advanced_menu_item_dropdown_indicator'] == 'yes') {
        ...
        //For Vertical Menu
        if ( isset( $settings['skin_five_eael_advanced_menu_item_indicator'] ) ) {
            ob_start();
            Icons_Manager::render_icon( $settings['skin_five_eael_advanced_menu_item_indicator'], [ 'aria-hidden' => 'true' ] );
        ...
        //For Dropdown Menu
        if ( isset( $settings['skin_five_eael_advanced_menu_dropdown_item_indicator'] ) ) {
            ob_start();
            Icons_Manager::render_icon( $settings['skin_five_eael_advanced_menu_dropdown_item_indicator'], [ 'aria-hidden' => 'true' ] );
