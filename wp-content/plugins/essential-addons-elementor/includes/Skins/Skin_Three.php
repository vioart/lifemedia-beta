...
class Skin_Three extends Skin_Base
{
    ...
    public function section_style_dropdown(Widget_Base $widget)
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'condition' => [
                    'skin_three_eael_advanced_menu_layout' => ['vertical'],
                ],
            ]
        );
    ...
    public function render()
    {
        ...
        $menu_classes = ['eael-advanced-menu', $settings['skin_three_eael_advanced_menu_dropdown_animation'], 'eael-advanced-menu-indicator', $settings['eael_advanced_menu_hamburger_menu_item_alignment'] ];
        ...
        //For Vertical Menu
        if ( isset( $settings['skin_three_eael_advanced_menu_item_indicator'] ) ) {
            ob_start();
            Icons_Manager::render_icon( $settings['skin_three_eael_advanced_menu_item_indicator'], [ 'aria-hidden' => 'true' ] );
        ...
        //For Dropdown Menu
        if ( isset( $settings['skin_three_eael_advanced_menu_dropdown_item_indicator'] ) ) {
            ob_start();
            Icons_Manager::render_icon( $settings['skin_three_eael_advanced_menu_dropdown_item_indicator'], [ 'aria-hidden' => 'true' ] );
