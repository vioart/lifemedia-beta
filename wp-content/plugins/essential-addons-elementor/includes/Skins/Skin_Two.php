...
class Skin_Two extends Skin_Base
{
    ...
    {
        return __('Skin Two', 'essential-addons-elementor');
    }
    ...
    public function section_style_dropdown(Widget_Base $widget)
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'eael-advanced-menu-dropdown-animate-zoom-in',
                'condition' => [
                    'skin_two_eael_advanced_menu_layout' => ['horizontal'],
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'condition' => [
                    'skin_two_eael_advanced_menu_layout' => ['vertical'],
                ],
            ]
        );
    ...
    public function render()
    {
        ...
        $menu_classes = ['eael-advanced-menu', $settings['skin_two_eael_advanced_menu_dropdown_animation'], 'eael-advanced-menu-indicator', $settings['eael_advanced_menu_hamburger_menu_item_alignment'] ];
        $container_classes = ['eael-advanced-menu-container', $settings['skin_two_eael_advanced_menu_item_alignment'], $settings['skin_two_eael_advanced_menu_dropdown_item_alignment']];
        ...
        if ($settings['skin_two_eael_advanced_menu_layout'] == 'horizontal') {
            $menu_classes[] = 'eael-advanced-menu-horizontal';
        } else {
            $menu_classes[] = 'eael-advanced-menu-vertical';
        }

        if (isset($settings['skin_two_eael_advanced_menu_item_dropdown_indicator']) && $settings['skin_two_eael_advanced_menu_item_dropdown_indicator'] == 'yes') {
        ...
        //For Vertical Menu
        if ( isset( $settings['skin_two_eael_advanced_menu_item_indicator'] ) ) {
            ob_start();
            Icons_Manager::render_icon( $settings['skin_two_eael_advanced_menu_item_indicator'], [ 'aria-hidden' => 'true' ] );
        ...
        //For Dropdown Menu
        if ( isset( $settings['skin_two_eael_advanced_menu_dropdown_item_indicator'] ) ) {
            ob_start();
            Icons_Manager::render_icon( $settings['skin_two_eael_advanced_menu_dropdown_item_indicator'], [ 'aria-hidden' => 'true' ] );
