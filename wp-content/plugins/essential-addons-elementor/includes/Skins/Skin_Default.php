...
class Skin_Default extends Skin_Base
{
    ...
    {
        return __('Default', 'essential-addons-elementor');
    }
    ...
    public function section_style_dropdown(Widget_Base $widget)
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'condition' => [
                    'default_eael_advanced_menu_layout' => ['horizontal'],
                ],
            ]
        );
    ...
    public function section_style_top_level_item(Widget_Base $widget)
    {
        ...
        $this->add_control(
            'eael_advanced_menu_item_hover_indicator_heading',
            [
                'label' => __('Dropdown Indicator', 'essential-addons-elementor'),
                'type' => Controls_Manager::HEADING,
        ...
        $this->add_control(
            'eael_advanced_menu_item_hover_indicator_note',
            [
                'label' => __('Important Note', 'essential-addons-elementor'),
                'show_label' => false,
                'type' => Controls_Manager::RAW_HTML,
    ...
    public function section_style_dropdown_item(Widget_Base $widget)
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .eael-advanced-menu-container .eael-advanced-menu.eael-advanced-menu-horizontal ul li i' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            'eael_advanced_menu_dropdown_item_hover_indicator_heading',
            [
                'label' => __('Dropdown Indicator', 'essential-addons-elementor'),
                'type' => Controls_Manager::HEADING,
    ...
    public function render()
    {
        ...
        //For Vertical Menu
        if ( isset( $settings['default_eael_advanced_menu_item_indicator'] ) ) {
            ob_start();
            Icons_Manager::render_icon( $settings['default_eael_advanced_menu_item_indicator'], [ 'aria-hidden' => 'true' ] );
        ...
        //For Dropdown Menu
        if ( isset( $settings['default_eael_advanced_menu_dropdown_item_indicator'] ) ) {
            ob_start();
            Icons_Manager::render_icon( $settings['default_eael_advanced_menu_dropdown_item_indicator'], [ 'aria-hidden' => 'true' ] );
