...
class Team_Member_Carousel extends Widget_Base
{
	...
	protected function render()
	{
		...
		if( 'yes' === $settings['enable_marquee'] ){
			$this->add_render_attribute( 'team-member-carousel', 'data-autoplay', '0.001' );
			$this->add_render_attribute( 'team-member-carousel', 'class', 'eael-marquee-carousel' );
		}
                            ...
                            <div class="eael-tm">
                                <div class="eael-tm-image">
									...
									if ( isset( $item['team_member_image_hyperlink'] ) && '' != $item['team_member_image_hyperlink']['url'] ) {
										$this->add_link_attributes( 'eael-team-member-img-link-'.$item['_id'], $item['team_member_image_hyperlink'] );
