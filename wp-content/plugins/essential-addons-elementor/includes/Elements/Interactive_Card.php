	...
	protected function register_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'default' => '#4d4d4d',
				'selectors' => [
					'{{WRAPPER}} .interactive-card .content .text, 
					{{WRAPPER}} .interactive-card .content p, 
					{{WRAPPER}} .interactive-card .content .content-overflow .text' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .interactive-card .content .text, {{WRAPPER}} .interactive-card .content p, {{WRAPPER}} .interactive-card .content .content-overflow .text',
			]
		);
...
?>
		...
		<div <?php $this->print_render_attribute_string('eael-interactive-card'); ?>>
					...
					<div class="image-screen">
						<div class="header">
							<?php if ( ! empty( $settings['eael_interactive_card_front_panel_counter'] ) ) {
								$html_tag = $settings['counter_html_tag'];
								$number_content = '<' . $settings['counter_html_tag'] . ' class="card-number">';
								$number_content .= $settings['eael_interactive_card_front_panel_counter'];
								$number_content .= '</' . $settings['counter_html_tag'] . '>';
								echo wp_kses( $number_content, Helper::eael_allowed_tags() );
							} ?>
							<?php if ( !empty( $settings['eael_interactive_card_front_panel_title'] ) ) : ?>
								<h2 class="title"><?php echo wp_kses( $settings['eael_interactive_card_front_panel_title'], Helper::eael_allowed_tags() ); ?></h2>
							<?php endif; ?>
						</div>
						<?php if ('content' == $settings['eael_interactive_card_text_type']) :  ?>
							<?php if (!empty($settings['eael_interactive_card_front_panel_content'])) : ?>
								<div class="front-text-body">
									<?php echo wp_kses( $settings['eael_interactive_card_front_panel_content'], Helper::eael_allowed_tags() ); ?>
								</div>
							<?php endif; ?>
							...
							<div class="footer">
								<a href="javascript:;" class="interactive-btn">
									...
									if ($settings['eael_interactive_card_is_show_front_panel_btn_icon'] == 'yes' && $settings['eael_interactive_card_front_panel_btn_icon_alignment'] == 'left') {
										echo '<span class="' . esc_attr( $settings['eael_interactive_card_front_panel_btn_icon_alignment'] ) . ' front-btn-icon"></i>';
									    Icons_Manager::render_icon( $settings['eael_interactive_card_front_panel_btn_icon'], [ 'aria-hidden' => 'true' ] );
										echo '</span>';
									}
									echo wp_kses( $settings['eael_interactive_card_front_panel_btn'], Helper::eael_allowed_tags() );
			...
			<div class="content">
				<span class="close close-me">
					...
					<?php else :
                            echo wp_kses( $icon, Helper::eael_allowed_icon_tags() );
                        endif; ?>
				</span>
						...
						<div class="text">
							<div class="text-inner">
								<?php if (!empty($settings['eael_interactive_card_rear_title'])) : ?>
									<h2 class="title"><?php echo wp_kses( $settings['eael_interactive_card_rear_title'], Helper::eael_allowed_tags() ); ?></h2>
								<?php endif; ?>
								<?php if ('content' == $settings['eael_interactive_card_rear_text_type']) : ?>
									<?php echo wp_kses( wpautop($settings['eael_interactive_card_rear_content']), Helper::eael_allowed_tags() ); ?>
								...
								<?php if (!empty($settings['eael_interactive_card_rear_btn'])) : 
									$this->add_link_attributes( 'rear_link', $settings['eael_interactive_card_rear_btn_link'] );
									$this->add_render_attribute( 'rear_link', 'class', 'interactive-btn' );
									?>
									<a <?php $this->print_render_attribute_string( 'rear_link' ); ?>>
										<?php
										if ($settings['eael_interactive_card_is_show_rear_panel_btn_icon'] == 'yes' && $settings['eael_interactive_card_rear_panel_btn_icon_alignment'] == 'left') {
											echo '<span class="' . esc_attr( $settings['eael_interactive_card_rear_panel_btn_icon_alignment'] ) . ' rear-btn-icon"></i>';
											Icons_Manager::render_icon( $settings['eael_interactive_card_rear_panel_btn_icon'], [ 'aria-hidden' => 'true' ] );
											echo '</span>';
										}
										echo wp_kses( $settings['eael_interactive_card_rear_btn'], Helper::eael_allowed_icon_tags() );
