...
class Woo_Product_Slider extends Widget_Base {
    ...
    protected function eael_get_product_filterby_options() {
        return apply_filters( 'eael/woo-product-slider/filterby-options', [
            ...
            'related-products' 		=> esc_html__('Related Products', 'essential-addons-elementor'),
	...
	protected function eael_woo_product_slider_terms_style() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Terms', 'essential-addons-elementor' ),
		...
		$this->start_controls_tab( 'eael_product_carousel_terms_style_tabs_normal', [ 'label' => esc_html__( 'Normal', 'essential-addons-elementor' ) ] );
		...
		$this->start_controls_tab( 'eael_product_carousel_terms_hover_styles', [ 'label' => esc_html__( 'Hover', 'essential-addons-elementor' ) ] );
    ...
    protected function eael_woo_product_slider_layout() {
	    ...
	    $this->add_control(
			...
			[
				'label'        => __( 'Show Post Terms', 'essential-addons-elementor' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => __( 'Show', 'essential-addons-elementor' ),
				'label_off'    => __( 'Hide', 'essential-addons-elementor' ),
				'return_value' => 'yes',
	    ...
	    $this->add_control(
		    ...
		    [
			    'label' => esc_html__('Image Clickable?', 'essential-addons-elementor'),
			    'type' => Controls_Manager::SWITCHER,
			    'return_value' => 'yes',
			    'default' => 'no',
		    ]
    ...
    protected function eael_woo_product_slider_query() {
        ...
        $this->add_control(
            ...
            [
                'type'            => Controls_Manager::RAW_HTML,
                'raw'             => __( 'This filter will only affect in <strong>Single Product</strong> page of <strong>Elementor Theme Builder</strong> dynamically.', 'essential-addons-elementor' ),
                'content_classes' => 'eael-warning',
                'condition'       => [
        ...
        $this->add_control( 'product_offset', [
            ...
            'default' => 0,
            'condition'     => [
                'eael_product_slider_product_filter!'  => 'manual'
            ],
        ] );

        $this->add_control(
            'eael_product_slider_products_in', 
            [
            'label'         => esc_html__( 'Select Products', 'essential-addons-elementor' ),
            'type'          => 'eael-select2',
            'label_block'   => true,
            'multiple'      => true,
            'source_type'   => 'product',
        ...
        $this->add_control(
            ...
            [
                'label'       => __('Purchase Type', 'essential-addons-elementor'),
                'type'        => Controls_Manager::SELECT,
                'description' => __('For logged in users only!', 'essential-addons-elementor'),
                'options'     => [
                    'both'          => __('Both', 'essential-addons-elementor'),
                    'purchased'     => __('Purchased Only', 'essential-addons-elementor'),
                    'not-purchased' => __('Not Purchased Only', 'essential-addons-elementor'),
                ],
                'default' => 'both',
            ]
    );
    ...
    protected function eael_woo_product_slider_buttons_style() {
	    ...
	    $this->add_control(
		    ...
		    [
			    ...
			    'type'      => Controls_Manager::COLOR,
			    'selectors' => [
				    '{{WRAPPER}} .eael-woo-product-slider .eael-product-slider .eael-add-to-cart-button .button, {{WRAPPER}} .eael-woo-product-slider .eael-product-slider .eael-add-to-cart-button .button.add_to_cart_button, {{WRAPPER}} .eael-woo-product-slider .eael-product-slider .eael-add-to-cart-button .added_to_cart' => 'color: {{VALUE}} !important;',
			    ],
		    ]
	    );
	    ...
	    $this->add_control(
		    ...
		    [
			    ...
			    'type'      => Controls_Manager::COLOR,
			    'selectors' => [
				    '{{WRAPPER}} .eael-woo-product-slider .eael-product-slider .eael-add-to-cart-button .button, {{WRAPPER}} .eael-woo-product-slider .eael-product-slider .eael-add-to-cart-button .button.add_to_cart_button, {{WRAPPER}} .eael-woo-product-slider .eael-product-slider .eael-add-to-cart-button .added_to_cart' => 'background-color: {{VALUE}} !important;',
			    ],
		    ]
	    );
	    ...
	    $this->add_control(
		    ...
		    [
			    ...
			    'default'   => '#F12DE0',
			    'selectors' => [
				    '{{WRAPPER}} .eael-woo-product-slider .eael-product-slider .eael-add-to-cart-button .button:hover, {{WRAPPER}} .eael-woo-product-slider .eael-product-slider .eael-add-to-cart-button .button.add_to_cart_button:hover, {{WRAPPER}} .eael-woo-product-slider .eael-product-slider .eael-add-to-cart-button .added_to_cart:hover' => 'background-color: {{VALUE}} !important;',
			    ],
		    ]
	    );
    ...
    public function product_query_builder(){
        ...
        if ( $filter == 'manual' ) {
            $args['post__in'] = ! empty( $settings['eael_product_slider_products_in'] ) ? $settings['eael_product_slider_products_in'] : [ 0 ];
        }
