...
class Divider extends Widget_Base
{
    ...
    protected function render() {
		...
		if ( isset( $settings['divider_direction'] ) ) {
...
?>
		<div <?php $this->print_render_attribute_string('divider-wrap'); ?>>
			<?php
					...
					<div class="divider-text-wrap">
						...
						<span class="eael-divider-content">
							<?php if ($settings['divider_type'] == 'text' && $settings['divider_text']) {
								echo '<' . Helper::eael_validate_html_tag( $settings['text_html_tag'] ) . ' '; $this->print_render_attribute_string( 'divider_text' ); echo '>';
								echo esc_html( $settings['divider_text'] );
								echo '</' . Helper::eael_validate_html_tag( $settings['text_html_tag'] ) . '>';
