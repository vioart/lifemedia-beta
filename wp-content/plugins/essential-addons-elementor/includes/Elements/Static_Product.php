                    ...
                    <div class="eael-static-product-thumb-overlay">
                        <div class="eael-static-product-details">
                            <?php if (!empty($settings['eael_static_product_heading'])) : ?>
                                <h2><a href="<?php echo esc_url( $settings['eael_static_product_link_url'] ); ?>" target="<?php echo esc_attr( $settings['eael_static_product_link_target'] ); ?>"><?php echo esc_html( $settings['eael_static_product_heading'] ); ?></a></h2>
                            <?php endif; ?>
                            <?php if ($settings['eael_static_product_is_show_price'] === 'yes' || $settings['eael_static_product_is_show_rating'] === 'yes') : ?>
                                <div class="eael-static-product-price-and-reviews">
                                    <?php if (isset($settings['eael_static_product_is_show_price']) && $settings['eael_static_product_is_show_price'] === 'yes') : ?>
                                        <span class="eael-static-product-price"><?php echo (!empty($settings['eael_static_product_price']) ? esc_html( $settings['eael_static_product_price'] ) : ''); ?></span>
                                    <?php endif; ?>
                                    <?php if (isset($settings['eael_static_product_is_show_rating']) && $settings['eael_static_product_is_show_rating'] === 'yes') : ?>
                                        <span class="eael-static-product-reviews"><?php echo (!empty($settings['eael_static_product_review']) ? esc_html( $settings['eael_static_product_review'] ) : ''); ?></span>
                                    <?php endif; ?>
                                </div>
                            <?php endif; ?>
                            <p><?php echo wp_kses( $settings['eael_static_product_description'], Helper::eael_allowed_tags() ); ?></p>
                            <?php if ($settings['eael_static_product_show_details_btn'] === 'yes' || $settings['eael_static_product_show_add_to_cart_button'] === 'yes') : ?>
                                <div class="eael-static-product-btn-wrap">
                                    <?php if ($settings['eael_static_product_show_details_btn'] === 'yes' && !empty($settings['eael_static_product_btn'])) : ?>
                                        <a href="<?php echo esc_url( $settings['eael_static_product_link_url'] ); ?>" target="<?php echo esc_attr( $settings['eael_static_product_link_target'] ); ?>" class="eael-static-product-btn">
                                            <span class="eael-static-product-btn-inner">
                                    ...
                                    <?php if (!empty($settings['eael_static_product_demo_text'])) : ?>
                                        <a class="eael-static-product-live-demo-btn" href="<?php echo esc_url( $settings['eael_static_product_demo_link_url'] ); ?>" target="<?php echo esc_attr($settings['eael_static_product_demo_link_target']); ?>">
                                    ...
                                    <?php echo wp_kses( $cartButtonMarkup, Helper::eael_allowed_tags() ); ?>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="eael-static-product-thumb">
                        <?php echo '<img src="' . esc_url( $static_product_image['url'] ) . '" alt="' . esc_attr(get_post_meta($static_product_image['id'], '_wp_attachment_image_alt', true)) . '">'; ?>
                    </div>
                </div>
            </div>
        <?php else : ?>
                ...
                <div class="eael-static-product-media">
                    <div class="eael-static-product-thumb-overlay">
                        ...
                        if ($eael_static_product_layout === 'two') {
                            echo wp_kses( $cartButtonMarkup, Helper::eael_allowed_tags() );
                        }
                        ?>
                    </div>
                    <div class="eael-static-product-thumb">
