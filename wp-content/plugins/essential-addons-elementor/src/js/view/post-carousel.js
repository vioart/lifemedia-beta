...
var PostCarouselHandler = function($scope, $) {
	...
	eael.hooks.addAction("ea-toggle-triggered", "ea", PostCarouselLoader);
	eael.hooks.addAction("ea-lightbox-triggered", "ea", PostCarouselLoader);
	eael.hooks.addAction("ea-advanced-tabs-triggered", "ea", PostCarouselLoader);
	eael.hooks.addAction("ea-advanced-accordion-triggered", "ea", PostCarouselLoader);
};
...
jQuery(window).on("elementor/frontend/init", function() {
	...
	if (eael.elementStatusCheck('eaelPostSliderLoad')) {
		return false;
	}
