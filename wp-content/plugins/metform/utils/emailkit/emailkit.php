...
if( !class_exists('\Wpmet\Libs\Emailkit') ) {
	class Emailkit {
		...
		public function __construct() {
			...
			$dismissed_coutner = get_option('metform-edit_with_emailkit_banner_dismissed_'.get_current_user_id(), 0);			
			...
			\Oxaim\Libs\Notice::instance('metform', 'edit_with_emailkit_banner')
		...
		public function emailkit_admin_head() {
			?>
			<style>
				.notice-metform-edit_with_emailkit_banner{
				...
				.notice-metform-edit_with_emailkit_banner .edit-with-emailkit-banner-main{
					display: flex;
					gap: 15px;
				}
				.notice-metform-edit_with_emailkit_banner button::before{
					color: #ffffff;
				}

				.notice-metform-edit_with_emailkit_banner .notice-container-full-width{
					padding: 0;
					margin: 0 !important;
				}
				.notice-metform-edit_with_emailkit_banner .notice-container-full-width .edit-with-emailkit-wrapper{
					display: flex;
					justify-content: space-between;
					align-items: center;
				}
				.notice-metform-edit_with_emailkit_banner .notice-container-full-width .edit-with-emailkit-wrapper .edit-with-emailkit-banner-right{
					margin-right: 60px;
				}

				.notice-metform-edit_with_emailkit_banner .notice-container-full-width .edit-with-emailkit-wrapper .edit-with-emailkit-banner-left .edit-with-emailkit-banner-main .edit-with-emailkit-banner-logo{
					padding: 24px 8px 0px 8px;
					border-left: 6px solid #13d5ff;
					background: #FFFFFF1A;
				}
				.notice-metform-edit_with_emailkit_banner .notice-container-full-width .edit-with-emailkit-wrapper .edit-with-emailkit-banner-left .edit-with-emailkit-banner-middle{
					padding: 20px 4px;
				}
				.notice-metform-edit_with_emailkit_banner .notice-container-full-width .edit-with-emailkit-wrapper .edit-with-emailkit-banner-right .emailkit-install-activate-btn{
					font-size: 14px;
					font-weight: 500;
					color: #070C14;
					padding: 15px 22px;
